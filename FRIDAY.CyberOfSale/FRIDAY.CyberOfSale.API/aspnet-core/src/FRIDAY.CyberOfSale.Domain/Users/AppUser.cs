...
namespace FRIDAY.CyberOfSale.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CyberOfSaleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CyberOfSaleEfCoreEntityExtensionMappings to extend the IdentityUser entity
